...
export const requirementsData: Requirement[] = [
  {
    ...
    testCases: [
      { id: 'tc1', title: 'Verify order creation with valid data', status: 'Active', executionResult: 'Pass', lastRun: '2025-01-10', tester: 'Mike Chen', assignee: 'Mike Chen', dueDate: '2025-01-15', priority: 'High' },
      { id: 'tc2', title: 'Test validation error handling', status: 'Active', executionResult: 'Pass', lastRun: '2025-01-10', tester: 'Mike Chen', assignee: 'Mike Chen', dueDate: '2025-01-15', priority: 'Medium' },
    ...
    issues: [
      { id: 'i1', title: 'Date picker not showing correctly on mobile', severity: 'Medium', status: 'Active', assignee: 'Sarah Johnson', dueDate: '2025-01-22' },
    ],
    signOffs: [
      { id: 'so1', role: 'Business Owner', stakeholder: 'Emily Davis', status: 'Approved', date: '2025-01-08', priority: 'High', dueDate: '2025-01-10' },
      { id: 'so2', role: 'Technical Lead', stakeholder: 'Alex Kumar', status: 'New', priority: 'High', dueDate: '2025-01-15' },
    ],
    ctas: [
