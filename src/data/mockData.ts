...
export const requirementsData: Requirement[] = [
  {
    ...
    traceabilityStatus: 'fully-traced',
    releaseVersion: 'rel-1.0',
    owner: 'business',
    ...
    documents: [
      ...
      { id: 'd3', name: 'Technical_Design_Document.docx', type: 'DOCX', size: '3.1 MB', uploadedBy: 'Alex Kumar', uploadedAt: '2025-01-07' },
      { id: 'd4', name: 'Test_Cases_Specification.xlsx', type: 'XLSX', size: '890 KB', uploadedBy: 'Mike Chen', uploadedAt: '2025-01-08' },
      { id: 'd5', name: 'User_Acceptance_Criteria.pdf', type: 'PDF', size: '1.8 MB', uploadedBy: 'Emily Davis', uploadedAt: '2025-01-09' },
      { id: 'd6', name: 'API_Integration_Guide.md', type: 'MD', size: '156 KB', uploadedBy: 'Sarah Johnson', uploadedAt: '2025-01-10' },
      { id: 'd7', name: 'Database_Schema_Changes.sql', type: 'SQL', size: '78 KB', uploadedBy: 'Alex Kumar', uploadedAt: '2025-01-11' },
      { id: 'd8', name: 'Workflow_Diagram.png', type: 'PNG', size: '2.3 MB', uploadedBy: 'John Smith', uploadedAt: '2025-01-12' }
    ],
  ...
  },
  {
    ...
    traceabilityStatus: 'partially-traced',
    releaseVersion: 'rel-1.0',
    owner: 'technical',
    ...
    documents: [
      { id: 'd9', name: 'Credit_API_Spec.yaml', type: 'YAML', size: '45 KB', uploadedBy: 'Sarah Johnson', uploadedAt: '2025-01-08' },
      { id: 'd10', name: 'Security_Assessment.pdf', type: 'PDF', size: '1.5 MB', uploadedBy: 'Alex Kumar', uploadedAt: '2025-01-09' },
      { id: 'd11', name: 'Integration_Test_Plan.docx', type: 'DOCX', size: '2.2 MB', uploadedBy: 'Mike Chen', uploadedAt: '2025-01-10' },
      { id: 'd12', name: 'Performance_Benchmarks.xlsx', type: 'XLSX', size: '567 KB', uploadedBy: 'Emily Davis', uploadedAt: '2025-01-11' },
      { id: 'd13', name: 'Error_Handling_Scenarios.json', type: 'JSON', size: '89 KB', uploadedBy: 'Sarah Johnson', uploadedAt: '2025-01-12' }
    ],
  ...
  },
  {
    ...
    solutionType: 'custom-dev',
    traceabilityStatus: 'missing-design',
    releaseVersion: 'future',
    owner: 'functional',
    complianceCategory: 'not-applicable',
    riskLevel: 'low',
    changeImpact: 'none',
  ...
  },
  {
    ...
    solutionType: 'custom-dev',
    traceabilityStatus: 'partially-traced',
    releaseVersion: 'rel-1.1',
    owner: 'functional',
    complianceCategory: 'internal-policy',
    riskLevel: 'medium',
    changeImpact: 'has-open-cr',
    stageStatus: 'in-progress',
    sprintCycle: 'sprint-3',
    tags: ['PP', 'Capacity Planning', 'MRP'],
    tasks: [
      { id: 't10', title: 'Capacity planning algorithm', status: 'Active', assignee: 'Sarah Johnson', dueDate: '2025-01-25', priority: 'High' },
      { id: 't11', title: 'Scheduling UI', status: 'New', assignee: 'Sarah Johnson', dueDate: '2025-01-30', priority: 'Medium' },
    ],
  ...
  },
  {
    ...
    changeImpact: 'none',
    stageStatus: 'not-started',
    sprintCycle: 'unassigned',
    tags: ['MM', 'Forecasting', 'AI/ML'],
    tasks: [],
    testCases: [],
    issues: [],
    signOffs: [],
  ...
  },
  {
    ...
    complianceCategory: 'sox',
    riskLevel: 'high',
    changeImpact: 'versioned',
    stageStatus: 'in-progress',
    sprintCycle: 'sprint-2',
    tags: ['FI-GL', 'Period Close', 'Reconciliation'],
    tasks: [
      { id: 't12', title: 'Define closing checklist', status: 'Completed', assignee: 'Emily Davis', dueDate: '2025-01-10', priority: 'High' },
      { id: 't13', title: 'Implement reconciliation workflow', status: 'Active', assignee: 'Alex Kumar', dueDate: '2025-01-20', priority: 'High' },
    ],
  ...
  },
  {
    ...
    stageStatus: 'completed',
    sprintCycle: 'sprint-1',
    tags: ['HCM', 'Onboarding', 'Self-Service'],
    tasks: [
  ...
  },
  {
    ...
    approver: 'David Wilson',
    dueDate: '2025-02-15',
    lifecyclePhase: 'document',
    approvalStatus: 'pending',
    solutionType: 'enhancement',
    traceabilityStatus: 'missing-test',
    releaseVersion: 'hotfix',
    owner: 'qa',
    complianceCategory: 'iso',
    riskLevel: 'none',
    changeImpact: 'changed-after-approval',
    stageStatus: 'blocked',
    sprintCycle: 'backlog',
    tags: ['System', 'Reference', 'Testing'],
    tasks: [
      { id: 't17', title: 'Define cancellation rules', status: 'Completed', assignee: 'John Smith', dueDate: '2025-01-12', priority: 'Medium' },
      { id: 't18', title: 'Implement refund logic', status: 'Active', assignee: 'Sarah Johnson', dueDate: '2025-01-18', priority: 'High' },
    ],
    testCases: [
      { id: 'tc14', title: 'Test full cancellation', status: 'Active', executionResult: 'Pass', lastRun: '2025-01-11', tester: 'Mike Chen', assignee: 'Mike Chen', dueDate: '2025-01-15', priority: 'Medium' },
    ],
    issues: [],
    signOffs: [{ id: 'so10', role: 'Business Owner', stakeholder: 'Emily Davis', status: 'New', dueDate: '2025-01-20', priority: 'Medium' }],
    ctas: [],
    meetings: [],
    documents: [],
