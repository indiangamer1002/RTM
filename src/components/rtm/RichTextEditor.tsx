...
export const RichTextEditor = ({
  ...
  return (
    <div className={containerClasses}>
      ...
      <div className={cn("flex-grow overflow-auto", isFullscreen && "bg-background", !readOnly ? "quill-editor-wrapper" : "quill-readonly-wrapper")}>
        <ReactQuill 
          ref={editorRef}
       ...
       {/* Footer / Status */}
       {!readOnly && (
        <div className="px-3 py-1 bg-muted/20 border-t text-[10px] text-muted-foreground flex justify-between items-center">
