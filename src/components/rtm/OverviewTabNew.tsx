...
export const OverviewTab = ({ requirementId, currentStatus = 'New' }: OverviewTabProps) => {
  ...
  const [description, setDescription] = useState(isNewRequirement ? '' : `**Business Context:**
...
5. Insufficient logging for troubleshooting sync issues`);
  ...
  const [expectedOutcome, setExpectedOutcome] = useState(isNewRequirement ? '' : `**Primary Objectives:**
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-foreground">{isNewRequirement ? 'Today' : 'Jan 10, 2025'}</span>
                </div>
                <div className="flex justify-between">
